import 'bloc/ev_car_issue_page_bloc.dart';
import 'models/ev_car_issue_page_model.dart';
...
import 'package:dos/presentation/ev_car_page_bottomsheet/ev_car_page_bottomsheet.dart';

class EvCarIssuePageBottomsheet extends StatelessWidget {
  const EvCarIssuePageBottomsheet({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<EvCarIssuePageBloc>(
        create: (context) => EvCarIssuePageBloc(
            EvCarIssuePageState(evCarIssuePageModelObj: EvCarIssuePageModel()))
          ..add(EvCarIssuePageInitialEvent()),
        child: EvCarIssuePageBottomsheet());
  }
    ...
    return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(
              ...
              child: BlocSelector<EvCarIssuePageBloc, EvCarIssuePageState,
  ...
  Widget _buildRadioGroup(BuildContext context) {
    return Align(
        ...
        child: Padding(
            ...
            child: BlocBuilder<EvCarIssuePageBloc, EvCarIssuePageState>(
                builder: (context, state) {
              return state.evCarIssuePageModelObj!.radioList.isNotEmpty
                  ? Row(children: [
                      CustomRadioButton(
                          text: "lbl_normal".tr,
                          value:
                              state.evCarIssuePageModelObj?.radioList[0] ?? "",
                          groupValue: state.radioGroup,
                          padding: EdgeInsets.symmetric(vertical: 1.v),
                          onChange: (value) {
                            context
                                .read<EvCarIssuePageBloc>()
                      ...
                      Padding(
                          ...
                          child: CustomRadioButton(
                              text: "lbl_ev".tr,
                              value:
                                  state.evCarIssuePageModelObj?.radioList[1] ??
                                      "",
                              groupValue: state.radioGroup,
                              padding: EdgeInsets.symmetric(vertical: 1.v),
                              onChange: (value) {
  ...
  onTapSubmit(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (_) => EvCarPageBottomsheet.builder(context),
