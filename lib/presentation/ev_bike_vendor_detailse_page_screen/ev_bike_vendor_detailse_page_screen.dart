import 'bloc/ev_bike_vendor_detailse_page_bloc.dart';
import 'models/ev_bike_vendor_detailse_page_model.dart';
...
class EvBikeVendorDetailsePageScreen extends StatelessWidget {
  const EvBikeVendorDetailsePageScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<EvBikeVendorDetailsePageBloc>(
        create: (context) => EvBikeVendorDetailsePageBloc(
            EvBikeVendorDetailsePageState(
                evBikeVendorDetailsePageModelObj:
                    EvBikeVendorDetailsePageModel()))
          ..add(EvBikeVendorDetailsePageInitialEvent()),
        child: EvBikeVendorDetailsePageScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<EvBikeVendorDetailsePageBloc,
        EvBikeVendorDetailsePageState>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
              extendBody: true,
  ...
  /// Navigates to the evBikeRequestedPageScreen when the action is triggered.
