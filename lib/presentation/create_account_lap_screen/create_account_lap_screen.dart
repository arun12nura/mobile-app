...
class CreateAccountLapScreen extends StatelessWidget {
  CreateAccountLapScreen({Key? key}) : super(key: key);
            ...
            body: Form(
                ...
                child: SizedBox(
                    ...
                    child: SingleChildScrollView(
                      ...
                      _buildCreateAccountColumn(context),
  ...
  /// Section Widget
  Widget _buildCreateAccountColumn(BuildContext context) {
    return Container(
        width: double.maxFinite,
  ...
  /// Navigates to the accountCreatedLapScreen when the action is triggered.
  onTapEight(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.accountCreatedLapScreen);
  }
}
