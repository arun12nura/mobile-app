...
class EvBikePageBottomsheet extends StatelessWidget {EvBikePageBottomsheet({Key? key}) : super(key: key);
...
onTapSubmit(BuildContext context) { Navigator.pushNamed(context, AppRoutes.evBikeVendorDetailsePageScreen); } 
 }
