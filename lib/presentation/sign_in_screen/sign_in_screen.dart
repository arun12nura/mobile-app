...
class SignInScreen extends StatelessWidget {
  ...
  /// Navigates to the logInFourScreen when the action is triggered.
  onTapArrowDown(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.logInFourScreen);
  }

  /// Navigates to the accountCreatedTwoScreen when the action is triggered.
  onTapEight(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.accountCreatedTwoScreen);
  }
}
