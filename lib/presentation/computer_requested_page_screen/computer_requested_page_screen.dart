import 'bloc/computer_requested_page_bloc.dart';
import 'models/computer_requested_page_model.dart';
...
class ComputerRequestedPageScreen extends StatelessWidget {
  const ComputerRequestedPageScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<ComputerRequestedPageBloc>(
        create: (context) => ComputerRequestedPageBloc(
            ComputerRequestedPageState(
                computerRequestedPageModelObj: ComputerRequestedPageModel()))
          ..add(ComputerRequestedPageInitialEvent()),
        child: ComputerRequestedPageScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ComputerRequestedPageBloc, ComputerRequestedPageState>(
