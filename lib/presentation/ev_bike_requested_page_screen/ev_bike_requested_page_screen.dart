import 'bloc/ev_bike_requested_page_bloc.dart';
import 'models/ev_bike_requested_page_model.dart';
...
class EvBikeRequestedPageScreen extends StatelessWidget {
  const EvBikeRequestedPageScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<EvBikeRequestedPageBloc>(
        create: (context) => EvBikeRequestedPageBloc(EvBikeRequestedPageState(
            evBikeRequestedPageModelObj: EvBikeRequestedPageModel()))
          ..add(EvBikeRequestedPageInitialEvent()),
        child: EvBikeRequestedPageScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<EvBikeRequestedPageBloc, EvBikeRequestedPageState>(
