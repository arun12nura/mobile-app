...
class LogInBikeScreen extends StatelessWidget {
  LogInBikeScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the createAccountBikeScreen when the action is triggered.
  onTapTxtDonthaveanaccount(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.createAccountBikeScreen);
  }
}
