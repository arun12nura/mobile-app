import 'bloc/ev_car_vendor_details_bloc.dart';
import 'models/ev_car_vendor_details_model.dart';
...
class EvCarVendorDetailsScreen extends StatelessWidget {
  const EvCarVendorDetailsScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<EvCarVendorDetailsBloc>(
        create: (context) => EvCarVendorDetailsBloc(EvCarVendorDetailsState(
            evCarVendorDetailsModelObj: EvCarVendorDetailsModel()))
          ..add(EvCarVendorDetailsInitialEvent()),
        child: EvCarVendorDetailsScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<EvCarVendorDetailsBloc, EvCarVendorDetailsState>(
  ...
  /// Navigates to the evCarRequestedPageScreen when the action is triggered.
