import 'package:dos/core/app_export.dart';import 'package:dos/widgets/custom_elevated_button.dart';import 'package:dos/widgets/custom_radio_button.dart';import 'package:dos/widgets/custom_text_form_field.dart';import 'package:flutter/material.dart';import 'package:dos/presentation/ev_bike_page_bottomsheet/ev_bike_page_bottomsheet.dart';
// ignore_for_file: must_be_immutable
class EvBikeIssuePageBottomsheet extends StatelessWidget {EvBikeIssuePageBottomsheet({Key? key}) : super(key: key);
...
/// Shows a modal bottom sheet with [EvBikePageBottomsheet] 
/// widget content.
/// The sheet is displayed on top of the current view with scrolling enabled if 
/// content exceeds viewport height.
onTapSubmit(BuildContext context) { showModalBottomSheet(context: context, builder: (_)=>EvBikePageBottomsheet(),isScrollControlled: true); } 
 }
