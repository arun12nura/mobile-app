import 'bloc/computer_vendor_details_bloc.dart';
import 'models/computer_vendor_details_model.dart';
...
class ComputerVendorDetailsScreen extends StatelessWidget {
  const ComputerVendorDetailsScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<ComputerVendorDetailsBloc>(
        create: (context) => ComputerVendorDetailsBloc(
            ComputerVendorDetailsState(
                computerVendorDetailsModelObj: ComputerVendorDetailsModel()))
          ..add(ComputerVendorDetailsInitialEvent()),
        child: ComputerVendorDetailsScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ComputerVendorDetailsBloc, ComputerVendorDetailsState>(
  ...
  /// Navigates to the computerRequestedPageScreen when the action is triggered.
