import 'bloc/laptop_vendor_details_bloc.dart';
import 'models/laptop_vendor_details_model.dart';
...
class LaptopVendorDetailsScreen extends StatelessWidget {
  const LaptopVendorDetailsScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<LaptopVendorDetailsBloc>(
        create: (context) => LaptopVendorDetailsBloc(LaptopVendorDetailsState(
            laptopVendorDetailsModelObj: LaptopVendorDetailsModel()))
          ..add(LaptopVendorDetailsInitialEvent()),
        child: LaptopVendorDetailsScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<LaptopVendorDetailsBloc, LaptopVendorDetailsState>(
  ...
  /// Navigates to the laptopRequestedPageScreen when the action is triggered.
