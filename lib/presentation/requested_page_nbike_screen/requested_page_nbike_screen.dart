import 'bloc/requested_page_nbike_bloc.dart';
import 'models/requested_page_nbike_model.dart';
...
class RequestedPageNbikeScreen extends StatelessWidget {
  const RequestedPageNbikeScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<RequestedPageNbikeBloc>(
        create: (context) => RequestedPageNbikeBloc(RequestedPageNbikeState(
            requestedPageNbikeModelObj: RequestedPageNbikeModel()))
          ..add(RequestedPageNbikeInitialEvent()),
        child: RequestedPageNbikeScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<RequestedPageNbikeBloc, RequestedPageNbikeState>(
