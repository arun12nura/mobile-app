...
class CreateAccountCarScreen extends StatelessWidget {
  CreateAccountCarScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the accountCreatedCarScreen when the action is triggered.
  onTapEight(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.accountCreatedCarScreen);
  }
}
