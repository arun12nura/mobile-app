...
class ComputerPageBottomsheet extends StatelessWidget {ComputerPageBottomsheet({Key? key}) : super(key: key);
...
@override Widget build(BuildContext context) { return Container(width: double.maxFinite, padding: EdgeInsets.all(12.h), decoration: AppDecoration.gradientTealEToTealE.copyWith(borderRadius: BorderRadiusStyle.customBorderTL32), child: Column(mainAxisSize: MainAxisSize.min, children: [CustomImageView(imagePath: ImageConstant.imgImage155x335, height: 155.v, width: 335.h, radius: BorderRadius.vertical(top: Radius.circular(32.h))), SizedBox(height: 20.v), _buildRadioGroup(context), SizedBox(height: 16.v), _buildName(context), SizedBox(height: 11.v), _buildModelNameRow(context), SizedBox(height: 11.v), _buildWarrantyDetails(context), SizedBox(height: 11.v), _buildIssues(context), SizedBox(height: 20.v), _buildSubmitButton(context), SizedBox(height: 19.v)])); } 
/// Section Widget
Widget _buildRadioGroup(BuildContext context) { return Padding(padding: EdgeInsets.symmetric(horizontal: 31.h), child: Row(children: [CustomRadioButton(text: "Laptop", value: radioList[0], groupValue: radioGroup, padding: EdgeInsets.symmetric(vertical: 1.v), onChange: (value) {radioGroup = value;}), Padding(padding: EdgeInsets.only(left: 80.h), child: CustomRadioButton(text: "Computer", value: radioList[1], groupValue: radioGroup, padding: EdgeInsets.symmetric(vertical: 1.v), onChange: (value) {radioGroup = value;}))])); } 
/// Section Widget
Widget _buildName(BuildContext context) { return Padding(padding: EdgeInsets.only(left: 9.h, right: 8.h), child: CustomTextFormField(controller: nameController, hintText: "Brand Name", prefix: Container(margin: EdgeInsets.fromLTRB(15.h, 16.v, 2.h, 16.v), child: CustomImageView(imagePath: ImageConstant.imgComputer, height: 16.v, width: 24.h)), prefixConstraints: BoxConstraints(maxHeight: 50.v), borderDecoration: TextFormFieldStyleHelper.outlineBlackTL251, fillColor: appTheme.blueGray10068)); } 
/// Section Widget
...
/// Section Widget
Widget _buildWarrantyDetails(BuildContext context) { return Padding(padding: EdgeInsets.only(left: 9.h, right: 8.h), child: CustomTextFormField(controller: warrantyDetailsController, hintText: "Warranty Details", prefix: Container(margin: EdgeInsets.fromLTRB(15.h, 13.v, 2.h, 13.v), child: CustomImageView(imagePath: ImageConstant.imgShield, height: 24.adaptSize, width: 24.adaptSize)), prefixConstraints: BoxConstraints(maxHeight: 50.v))); } 
/// Section Widget
Widget _buildIssues(BuildContext context) { return Padding(padding: EdgeInsets.only(left: 9.h, right: 8.h), child: CustomTextFormField(controller: issuesController, hintText: "Issues", textInputAction: TextInputAction.done, prefix: Padding(padding: EdgeInsets.fromLTRB(18.h, 16.v, 30.h, 16.v), child: Row(mainAxisSize: MainAxisSize.min, children: [CustomImageView(imagePath: ImageConstant.imageNotFound, height: 18.adaptSize, width: 18.adaptSize), CustomImageView(imagePath: ImageConstant.imageNotFound, height: 12.v, width: 10.h, margin: EdgeInsets.fromLTRB(22.h, 16.v, 9.889999.h, 16.v))])), prefixConstraints: BoxConstraints(maxHeight: 50.v))); } 
/// Section Widget
Widget _buildSubmitButton(BuildContext context) { return CustomElevatedButton(width: 88.h, text: "Submit", onPressed: () {onTapSubmitButton(context);}); } 
/// Navigates to the computerVendorDetailsScreen when the action is triggered.
onTapSubmitButton(BuildContext context) { Navigator.pushNamed(context, AppRoutes.computerVendorDetailsScreen); } 
 }
