import 'controller/laptop_issue_page_one_controller.dart';import 'package:dos/core/app_export.dart';import 'package:dos/widgets/custom_elevated_button.dart';import 'package:dos/widgets/custom_radio_button.dart';import 'package:dos/widgets/custom_text_form_field.dart';import 'package:flutter/material.dart';import 'package:dos/presentation/computer_page_bottomsheet/computer_page_bottomsheet.dart';import 'package:dos/presentation/computer_page_bottomsheet/controller/computer_page_controller.dart';
// ignore_for_file: must_be_immutable
class LaptopIssuePageOneBottomsheet extends StatelessWidget {LaptopIssuePageOneBottomsheet(this.controller, {Key? key}) : super(key: key);

LaptopIssuePageOneController controller;
...
/// Section Widget
Widget _buildRadioGroup() { return Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(left: 17.h, right: 45.h), child: Obx(() => Row(children: [CustomRadioButton(text: "lbl_laptop".tr, value: controller.laptopIssuePageOneModelObj.value.radioList.value[0], groupValue: controller.radioGroup.value, padding: EdgeInsets.symmetric(vertical: 1.v), onChange: (value) {controller.radioGroup.value = value;}), Padding(padding: EdgeInsets.only(left: 80.h), child: CustomRadioButton(text: "lbl_computer".tr, value: controller.laptopIssuePageOneModelObj.value.radioList.value[1], groupValue: controller.radioGroup.value, padding: EdgeInsets.symmetric(vertical: 1.v), onChange: (value) {controller.radioGroup.value = value;}))])))); } 
/// Section Widget
