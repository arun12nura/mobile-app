...
class EvCarPageBottomsheet extends StatelessWidget {EvCarPageBottomsheet({Key? key}) : super(key: key);
...
onTapSubmit(BuildContext context) { Navigator.pushNamed(context, AppRoutes.evCarVendorDetailsScreen); } 
 }
