...
class AccountCreatedCarScreen extends StatelessWidget {
  const AccountCreatedCarScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: Container(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      _buildSeventyNineStack(context),
                      Spacer(),
                      SizedBox(
                          width: 216.h,
                          child: Text(
  ...
  /// Section Widget
  Widget _buildSeventyNineStack(BuildContext context) {
    return SizedBox(
        height: 273.v,
        width: 335.h,
